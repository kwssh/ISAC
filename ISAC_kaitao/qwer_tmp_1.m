function sum_rate_final = qwer()
    ...
    % PARAM.USER = [-150 150; -75 200; 75 200];
    % PARAM.UAV_START = [-10 0];
    % PARAM.UAV_END = [10 0];
    % PARAM.TARGET = [400 100];
    ...
    for episode_association = 1 : PARAM.NUM_EPISODE
        for episode = 1 : PARAM.NUM_EPISODE
            ...
            new_A_opt(new_A_opt > 0.974) = 1;
            new_A_opt(new_A_opt < 0.026) = 0;

            new_E_opt(new_E_opt > 0.974) = 1;
            new_E_opt(new_E_opt < 0.026) = 0;

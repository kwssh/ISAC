function sum_rate_final = qwer()
    ...
    PARAM.NUM_SENSING_TH = 10;
    PARAM.SENSING_TH_VEC = linspace(10^(-5),10^(-4),PARAM.NUM_SENSING_TH);
    ...
    for i = 1 : PARAM.NUM_SENSING_TH

        PARAM.SENSING_TH = PARAM.SENSING_TH_VEC(i);
        ...
        user_rate_avg(i) = sum(sum(objective_val_episode(episode))) / PARAM.TOTAL_TIME_SLOT;
    end

    semilogx(PARAM.SENSING_TH_VEC, user_rate_avg);
end
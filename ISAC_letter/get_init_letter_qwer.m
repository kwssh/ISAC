function V_l = get_init_letter(num_user, num_antenna, num_target, channel, channel_her, sinr_threshold, noise_power, sterring_target, sterring_target_her, sensing_threshold, p_max, p_circuit, pho)

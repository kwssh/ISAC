function get_received_BEAM_GAIN(W, R, num_user, num_antenna, sensing_th, scaling, distance_user, distance_target)
    ...
    for idx = 1:num_distance
        ...
        steering_distance = get_steering(distance(idx), 1);

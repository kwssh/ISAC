function uav = get_UAV_trajectory_min_max(uav_t, W_opt, R_opt, user, num_user, channel_gain, noise_power, sensing_th, num_target, target, trust_region, V_max, N, uav_z, delta_t)
    ...
    cvx_begin
        ...
        for n = 1 : N
            ...
            for k = 1 : num_user
                ...
                tau_tmp(k) = tau_tmp(k) + user_rate(k,n);
            end

function uav = get_UAV_position(uav_t, W_opt, R_opt, user, num_user, channel_gain, noise_power, sensing_th, num_target, target, trust_region, uav_z)
    ...
    cvx_begin
        ...
        for k = 1:num_user
            ...
            distance_k = get_distance(user(k,:), uav_t, uav_z);
        ...
        subject to
            ...
            for j = 1:num_target
                ...
                distance_target_UAV(j) = get_distance(target(j,:), uav, uav_z);
                distance_target_UAV_t(j) = get_distance(target(j,:), uav_t, uav_z);

function [uav_init, W_opt, R_opt] = get_init_trajectory_SF_min_max(target, num_antenna, num_user, num_target, sensing_th, p_max, scaling, V_max, N, start_x, end_x, uav_y, uav_z)

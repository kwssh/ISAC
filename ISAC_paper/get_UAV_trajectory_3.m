function uav_opt = get_UAV_trajectory_3(uav_t, W_opt, R_opt, user, num_user, channel_gain, noise_power, sensing_th, num_target, target, trust_region, V_max, N)
        ...
        cvx_begin
            ...
            expressions distance_target_UAV(num_target, N)
                ...
                for k = 1:num_user
                    ...
                    distance_k = get_distance(user(k,:), uav_t(n,:));
                    ...
                    user_rate(k,n) = c(k,n) + sum(d(:,:,k,n) .* (uav - uav_t(n,:)));
                end
                ...
                subject to
                    ...
                    distance_UAV = norm([uav(1,1) - uav_t(n,1); uav(1,2) - uav_t(n,2)]);
                    ...
                    elseif n == N
                        ...
                        velocity_UAV = norm([uav(1,1) - uav_opt(n-1,1); uav(1,2) - uav_opt(n-1,2)]);
                        velocity_UAV <= V_max;

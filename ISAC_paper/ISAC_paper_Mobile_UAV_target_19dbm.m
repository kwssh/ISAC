function sum_rate_final = ISAC_paper_Mobile_UAV_target()
    clear
    rng(123);
    ...
    for episode = 1:num_episdoe
        ...
        [W_opt, R_opt] = get_precoder_opt_trajectory(channel_t, channel_her_t, W, R, num_user, num_antenna, N);
